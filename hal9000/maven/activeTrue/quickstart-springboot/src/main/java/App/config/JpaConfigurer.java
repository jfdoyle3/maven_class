...
import App.support.jpa.CustomRepositoryFactoryBean;
import App.support.jpa.SpringSecurityAuditorAware;
...
@Configuration
@EnableJpaRepositories(basePackages = "App.web.repository", repositoryFactoryBeanClass = CustomRepositoryFactoryBean.class)
